...
public class StandardTemplateFieldCatalog {
    ...
    private static final List<TemplateFieldDefinition> FIELDS = List.of(
            ...
            field("supervisionContent", "Supervision content", "daily-content", "steps.DAILY_LOG.payload.dailyItems.groups[0].entries[0].supervisionContent", "Checked rebar", "Main supervision content.", ALL_DAILY_LOG_REPORT_TYPES),
