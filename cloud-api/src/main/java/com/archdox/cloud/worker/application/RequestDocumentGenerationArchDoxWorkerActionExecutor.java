...
@Component
public class RequestDocumentGenerationArchDoxWorkerActionExecutor implements ArchDoxWorkerActionExecutor {
    private final ArchDoxWorkerDocumentActionService actionService;
    private final ArchDoxWorkerChatService chatService;

    public RequestDocumentGenerationArchDoxWorkerActionExecutor(
    ...
    public ArchDoxWorkerActionType actionType() {
        return ArchDoxWorkerActionType.REQUEST_DOCUMENT_GENERATION;
    }
    ...
    public ArchDoxWorkerActionResult execute(ArchDoxWorkerExecutionContext context) {
        ...
        var result = actionService.requestDocumentGeneration(context);
        if (chatContext != null) {
            chatService.completeDocumentGenerationFromWorker(
                    context.request().context().officeId(),
