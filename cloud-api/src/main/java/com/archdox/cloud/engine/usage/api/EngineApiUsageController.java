...
@RestController
@RequestMapping("/api/v1/engine/usage")
public class EngineApiUsageController {
    private final EngineApiUsageReadService service;

    public EngineApiUsageController(EngineApiUsageReadService service) {
