...
public class EngineExternalReviewSessionController {
    private final EngineExternalReviewSessionService service;

    public EngineExternalReviewSessionController(EngineExternalReviewSessionService service) {
    ...
    public EngineReviewSessionResponse create(
        ...
        return service.create(request, apiPrincipal(authentication));
    }
    ...
    public EngineReviewSessionResponse get(
        ...
        return service.get(reviewSessionId, apiPrincipal(authentication));
    }
    ...
    public EngineReviewResultResponse getResult(
        ...
        return service.getResult(reviewSessionId, apiPrincipal(authentication));
    }
    ...
    public EngineReviewSessionResponse submitDocument(
        ...
        return service.submitDocument(reviewSessionId, request, apiPrincipal(authentication));
    }
    ...
    public EngineReviewSessionResponse submitFacts(
        ...
        return service.submitFacts(reviewSessionId, request, apiPrincipal(authentication));
    }
    ...
    public EngineReviewSessionResponse normalize(
        ...
        return service.normalize(reviewSessionId, apiPrincipal(authentication));
    }
    ...
    public EngineReviewSessionResponse runValidation(
        ...
        return service.runValidation(reviewSessionId, apiPrincipal(authentication));
    }
