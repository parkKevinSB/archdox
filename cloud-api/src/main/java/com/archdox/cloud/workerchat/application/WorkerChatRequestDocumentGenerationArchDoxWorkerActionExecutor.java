...
@Component
public class WorkerChatRequestDocumentGenerationArchDoxWorkerActionExecutor implements ArchDoxWorkerActionExecutor {
    private final ArchDoxWorkerChatService chatService;

    public WorkerChatRequestDocumentGenerationArchDoxWorkerActionExecutor(ArchDoxWorkerChatService chatService) {
    ...
    public ArchDoxWorkerActionResult execute(ArchDoxWorkerExecutionContext context) {
        ...
        try {
            chatService.requestDocumentGenerationFromWorker(
                    officeId,
                    userId,
                    projectId,
                    sessionId,
