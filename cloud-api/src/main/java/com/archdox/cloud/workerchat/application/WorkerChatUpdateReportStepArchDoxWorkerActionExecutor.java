...
@Component
public class WorkerChatUpdateReportStepArchDoxWorkerActionExecutor implements ArchDoxWorkerActionExecutor {
    private final ArchDoxWorkerChatService chatService;

    public WorkerChatUpdateReportStepArchDoxWorkerActionExecutor(ArchDoxWorkerChatService chatService) {
        this.chatService = chatService;
    }

    @Override
    public ArchDoxWorkerActionType actionType() {
        return ArchDoxWorkerActionType.UPDATE_REPORT_STEP;
    }
    ...
    public ArchDoxWorkerActionResult execute(ArchDoxWorkerExecutionContext context) {
        ...
        try {
            chatService.updateReportStepFromWorker(officeId, userId, projectId, sessionId, assistantMessageId, context.action().payload());
