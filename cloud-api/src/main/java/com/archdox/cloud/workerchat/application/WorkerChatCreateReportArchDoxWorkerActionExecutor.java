...
@Component
public class WorkerChatCreateReportArchDoxWorkerActionExecutor implements ArchDoxWorkerActionExecutor {
    private final ArchDoxWorkerChatService chatService;

    public WorkerChatCreateReportArchDoxWorkerActionExecutor(ArchDoxWorkerChatService chatService) {
        this.chatService = chatService;
    }

    @Override
    public ArchDoxWorkerActionType actionType() {
        return ArchDoxWorkerActionType.CREATE_REPORT;
    }
    ...
    public ArchDoxWorkerActionResult execute(ArchDoxWorkerExecutionContext context) {
        ...
        try {
            chatService.createReportFromWorker(officeId, userId, projectId, sessionId, assistantMessageId, context.action().payload());
