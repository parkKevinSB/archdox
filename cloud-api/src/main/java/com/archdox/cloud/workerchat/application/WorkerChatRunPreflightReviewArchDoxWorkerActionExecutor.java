...
@Component
public class WorkerChatRunPreflightReviewArchDoxWorkerActionExecutor implements ArchDoxWorkerActionExecutor {
    private final ArchDoxWorkerChatService chatService;

    public WorkerChatRunPreflightReviewArchDoxWorkerActionExecutor(ArchDoxWorkerChatService chatService) {
    ...
    public ArchDoxWorkerActionResult execute(ArchDoxWorkerExecutionContext context) {
        ...
        try {
            chatService.runPreflightReviewFromWorker(
                    officeId,
                    userId,
                    projectId,
                    sessionId,
