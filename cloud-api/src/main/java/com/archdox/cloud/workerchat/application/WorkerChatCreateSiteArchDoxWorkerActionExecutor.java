...
@Component
public class WorkerChatCreateSiteArchDoxWorkerActionExecutor implements ArchDoxWorkerActionExecutor {
    private final ArchDoxWorkerChatService chatService;

    public WorkerChatCreateSiteArchDoxWorkerActionExecutor(ArchDoxWorkerChatService chatService) {
        this.chatService = chatService;
    }

    @Override
    public ArchDoxWorkerActionType actionType() {
        return ArchDoxWorkerActionType.CREATE_SITE;
    }
    ...
    public ArchDoxWorkerActionResult execute(ArchDoxWorkerExecutionContext context) {
        ...
        try {
            chatService.createSiteFromWorker(officeId, userId, projectId, sessionId, assistantMessageId, context.action().payload());
