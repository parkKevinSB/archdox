...
public class SiteSupervisionLedgerService {
        ...
        for (int groupIndex = 0; groupIndex < groups.size(); groupIndex++) {
            ...
            for (int itemIndex = 0; itemIndex < items.size(); itemIndex++) {
                ...
                entries.add(new SiteSupervisionEntry(
                        ...
                        trimToNull(catalogSelection.tradeGroupCode()),
                        trimToNull(catalogSelection.tradeGroupName()),
                        trimToNull(catalogSelection.tradeCode()),
                        trimToNull(catalogSelection.tradeName()),
                        trimToNull(catalogSelection.subTradeCode()),
                        trimToNull(catalogSelection.subTradeName()),
                        trimToNull(catalogSelection.phaseChecklistGroupCode()),
                        trimToNull(catalogSelection.phaseChecklistGroupName()),
    ...
    private SiteSupervisionEntryResponse toResponse(SiteSupervisionEntry entry) {
        return new SiteSupervisionEntryResponse(
                ...
                entry.floorArea(),
                entry.groupType(),
                entry.tradeGroupCode(),
                entry.tradeGroupName(),
                entry.tradeCode(),
                entry.tradeName(),
                entry.subTradeCode(),
                entry.subTradeName(),
                entry.phaseChecklistGroupCode(),
                entry.phaseChecklistGroupName(),
                entry.phaseCode(),
                entry.phaseName(),
                entry.processCode(),
                entry.processName(),
