...
public class InspectionReportController {
    ...
    public void delete(@PathVariable Long reportId, Authentication authentication) {
        inspectionReportService.delete(reportId, (UserPrincipal) authentication.getPrincipal());
    }
}
