...
public final class GenerateThumbnailPhotoStep extends Step {
    ...
    public GenerateThumbnailPhotoStep(
        ...
        this.event = event;
        this.task = new PhotoDerivativeStepTask("generate-thumbnail", event, executor, properties);
    }

    @Override
    protected StepResult onTick(StepContext ctx) {
        return task.tick(ctx, () -> derivativeService.generateThumbnail(event.officeId(), event.photoId()));
    }
