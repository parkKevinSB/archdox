...
public final class BuildPlatformOpsDailyReportSnapshotStep extends Step {
    private final PlatformOpsDailyReportService service;
    private final PlatformOpsDailyReportRequested event;

    public BuildPlatformOpsDailyReportSnapshotStep(
    ...
    protected StepResult onTick(StepContext ctx) {
        service.buildDailyReportSnapshot(event.opsRunId());
