...
public final class AwaitPlatformOpsAiDiagnosisHarnessStep extends Step {
    private final PlatformOpsDiagnosisService diagnosisService;
    private final PlatformOpsDiagnosisRequested event;

    public AwaitPlatformOpsAiDiagnosisHarnessStep(
    ...
    protected StepResult onTick(StepContext ctx) {
        try {
            if (diagnosisService.isAiHarnessTerminal(event.opsRunId())) {
