...
export type LegalDomainBinding = {
  ...
  checklistItemBasis?: string | null;
...
export type LegalDomainBindingCoverageItem = {
  catalogCode: string;
  catalogVersion: number;
  tradeCode: string;
  tradeName: string;
  ...
  autoGeneratedBindingCount: number;
  manualBindingCount: number;
  bindings: LegalDomainBinding[];
};

export type LegalDomainBindingCoverage = {
  catalogCode: string;
  catalogVersion: number;
  catalogName: string;
  catalogItemCount: number;
  activeBoundItemCount: number;
  missingItemCount: number;
  inactiveOnlyItemCount: number;
  totalBindingCount: number;
  autoGeneratedBindingCount: number;
  manualBindingCount: number;
  missingItems: LegalDomainBindingCoverageItem[];
  items: LegalDomainBindingCoverageItem[];
};
